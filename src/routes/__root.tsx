...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ARN Security operations platform for sites, attendance, incidents, and CCTV." },
      { name: "author", content: "ARN Security" },
      { property: "og:title", content: "ARN Security — Operations Platform" },
      { property: "og:description", content: "ARN Security operations platform for sites, attendance, incidents, and CCTV." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ARN Security — Operations Platform" },
      { name: "twitter:description", content: "ARN Security operations platform for sites, attendance, incidents, and CCTV." },
...
function RootComponent() {
  ...
  const bare = pathname === "/" || pathname === "/auth";
