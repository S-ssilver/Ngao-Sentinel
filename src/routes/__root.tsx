...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "NGAO operations platform for sites, attendance, incidents, and CCTV." },
      { name: "author", content: "NGAO" },
      { property: "og:title", content: "NGAO Sentinel Platform" },
      { property: "og:description", content: "NGAO operations platform for sites, attendance, incidents, and CCTV." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "NGAO Sentinel Platform" },
      { name: "twitter:description", content: "NGAO operations platform for sites, attendance, incidents, and CCTV." },
